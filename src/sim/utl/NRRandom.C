...
double NR::gasdev(int &idum)
{
	...
	if (iset == 0) {
		do {
			v1=2.0*ran1(idum)/2147483647.0-1.0;
			v2=2.0*ran1(idum)/2147483647.0-1.0;
			rsq=v1*v1+v2*v2;
